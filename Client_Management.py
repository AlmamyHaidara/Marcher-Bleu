...
class ClientManagement(object):
    def __init__(self, wine):
        ...
        self.label_prix = Label(self.win, text='Prix : ', font=("Microsoft YaHei Light", 12), fg='#001524').place(x=550,
                                                                                                                  y=220)
        ...
        self.modifier_button = Button(self.win, text='Modifier', font=('Bahnschrift', 12, 'bold'),
                                      width=9, bg='#5598D1', fg='#fff', border=0, command=self.Select_recore).place(
            x=490, y=280)

        self.mise_button = Button(self.win, text='Mise à jour', font=('Bahnschrift', 12, 'bold'),
                                  width=9, bg='#5598D1', fg='#fff', border=0, command=self.updete_recor).place(x=600,
                                                                                                               y=280)
